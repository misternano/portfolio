...
import SpotifyListener from "../components/Spotify.jsx";
	...
	return (
		<>
			<header className="relative h-[80vh] lg:h-[90vh] lg:m-10 m-2 flex md:flex-row flex-col md:gap-40 gap-4 justify-center items-center rounded-[8rem]">
				...
				<a onClick={scrollDown} className="group absolute left-1/2 md:bottom-0 bottom-5 transition-all duration-300" style={{ opacity: opacity }}>
