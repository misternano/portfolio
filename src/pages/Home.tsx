								...
								<div className="flex flex-col items-center">
									...
									<div className="flex flex-col items-center gap-4 z-20">
										<div className="flex flex-row gap-5 w-full md:w-fit pt-4 px-4 justify-center border-t border-neutral-700">
											...
											<Social size="h-12 md:h-10" link="https://www.steamcommunity.com/id/misternano/" platform="steam">
											...
											<Social size="h-12 md:h-10" link="https://github.com/misternano/" platform="github">
