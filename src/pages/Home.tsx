...
import {Avatar, ProjectCard, ContactCard, StockCard, Layout, SocialLink} from "../components";
						...
						<div className="flex flex-col items-center gap-4">
							...
							<div className="flex flex-col items-center gap-4">
								<div className="flex flex-row gap-5 w-full md:w-fit pt-4 px-4 justify-center border-t border-neutral-700">
									<SocialLink size="h-12 md:h-10" color="white" link="https://www.discord.com/users/272535850200596480/" platform="discord">
