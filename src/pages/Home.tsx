				...
				<main className="mt-[20vh] md:mt-[40vh] m-2" ref={scrollRef}>
					<section id="about" ref={motionRef}>
						...
						<div className="w-[90%] md:w-[75%] mx-auto flex flex-col gap-4">
							...
							<motion.div initial={{ y: 15, opacity: 0 }} animate={controlsY} className="pt-4 flex flex-nowrap gap-4 border border-neutral-700 rounded-xl order-3 xl:col-span-4 overflow-x-scroll">
