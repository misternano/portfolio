...
import { Avatar, ProjectCard, ContactCard, StockCard, Layout } from "../components";
		...
		<Layout>
						...
						<div className="flex flex-col items-center gap-4">
							...
							<div className="flex flex-col items-center gap-4">
								<div className="flex flex-row gap-5 w-full md:w-fit pt-4 px-4 justify-center border-t border-neutral-700">
									<a href="https://www.discord.com/users/272535850200596480/" target="norel noopen" id="discord">
										<svg viewBox="0 0 512 512" className="h-12 md:h-10 w-auto cursor-pointer hover:scale-110 fill-neutral-200 transition duration-300 hover:fill-discord">
									...
									<a href="https://www.twitter.com/fruitynano/" target="norel noopen" id="twitter">
										<svg viewBox="0 0 512 512" className="h-12 md:h-10 w-auto cursor-pointer hover:scale-110 fill-neutral-200 transition duration-300 hover:fill-twitter">
									...
									<a href="https://www.steamcommunity.com/id/misternano/" target="norel noopen" id="steam">
										<svg viewBox="0 0 512 512" className="h-12 md:h-10 w-auto cursor-pointer hover:scale-110 fill-neutral-200 transition duration-300 hover:fill-steam">
									...
									<a href="https://github.com/misternano/" target="norel noopen" id="github">
										<svg viewBox="0 0 512 512" className="h-12 md:h-10 w-auto cursor-pointer hover:scale-110 fill-neutral-200 transition duration-300 hover:fill-github">
			...
			<button onClick={() => scrollRef.current?.scrollIntoView()} className="group absolute left-1/2 bottom-5 animate-bounce transition-all duration-300 focus:outline-0" style={{ opacity: opacity }}>
				<div className="flex flex-col justify-center items-center -translate-x-1/2">
					<span className="font-lexend uppercase text-xs font-semibold text-neutral-300 group-hover:text-white group-focus:text-white transition-colors group-focus:underline underline-offset-4">
						learn more
					</span>
			...
			<main className="mt-[20vh] md:mt-[40vh] m-2" ref={scrollRef}>
				<section id="about">
					...
					<motion.div ref={motionRef} initial={{ x: 15, opacity: 0 }} animate={controlsX} className="w-[90%] md:w-[75%] mx-auto grid grid-cols-1 2xl:grid-cols-3 items-center gap-4">
						<motion.div ref={motionRef} initial={{ x: 15, opacity: 0 }} animate={controlsX} className="order-2 2xl:order-1 grid grid-cols-2 xl:grid-cols-4 gap-4 2xl:col-span-2">
				...
				<section id="projects">
					...
					<motion.div ref={motionRef} initial={{ y: 15, opacity: 0 }} animate={controlsY} className="w-[90%] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-4">
