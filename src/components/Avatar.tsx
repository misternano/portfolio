	...
	return (
		<>
			<div className="relative">
				<img src={data?.discord_user.avatar ? `https://cdn.discordapp.com/avatars/272535850200596480/${data?.discord_user.avatar}.png` : placeholder} alt="Avatar" className={`relative ${borderColor} w-48 md:w-52 h-auto backdrop-blur-xl bg-neutral-800/50 rounded-full border-2 z-20`} />
