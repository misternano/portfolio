	...
	return (
		<footer
			...
			<div className="flex flex-row gap-4 justify-center">
				...
				<Social size="h-9 md:h-7" link="https://www.steamcommunity.com/id/misternano/">
					<path
				...
				<Social size="h-9 md:h-7" link="https://github.com/misternano/">
					<path
			...
			<div className="h-full justify-self-end">
				<SignedOut>
					<SignInButton>
						<Button name="Sign In" icon={<LogIn size="16" className="stroke-neutral-300 group-hover:stroke-white transition-colors" />} />
					</SignInButton>
				</SignedOut>
				<SignedIn>
