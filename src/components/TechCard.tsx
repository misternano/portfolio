...
const TechCard: React.FC<{ tech: Tech }> = ({ tech }) => {
	return (
		<a href={`https://${tech.url}/`} target="norel noopen" className="tech min-w-fit p-2 md:p-4 flex flex-col gap-2 justify-center items-center bg-smallcard border border-neutral-700 rounded-xl glow hover:border-neutral-500 transition-colors duration-200">
