...
const Spotify = () => {
	...
	return (
		<div className="md:w-fit absolute right-2 left-2 top-1">
			...
			<div className="group md:w-96 backdrop-blur-sm ring-1 ring-border hover:ring-[#1fdf64]/75 bg-background rounded-lg transition-all">
