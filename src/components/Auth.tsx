...
const Auth = () => {
	...
	return (
		<>
			{!user &&
				<button onClick={login} className="group py-0.5 px-3 flex flex-row gap-2 items-center bg-[#171717] rounded-full justify-self-end">
			...
			{user &&
				<button onClick={logout} className="group py-0.5 px-3 flex flex-row gap-2 items-center bg-[#171717] rounded-full justify-self-end">
